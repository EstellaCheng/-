...
url='http://www.dianping.com/search/keyword/5/10_%E9%9B%A8%E8%8A%B1%E5%8F%B0%E5%8C%BA/p' #雨花台区
for i in page:
...
dataframe.to_csv("YuHuaTai.csv",index=False, sep=',')
