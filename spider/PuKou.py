...
url='http://www.dianping.com/search/keyword/5/10_%E6%B5%A6%E5%8F%A3%E5%8C%BA/p'  #浦口区
for i in page:
...
dataframe.to_csv("PuKou.csv",index=False, sep=',')