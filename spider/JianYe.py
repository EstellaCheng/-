...
url='http://www.dianping.com/search/keyword/5/10_%E5%BB%BA%E9%82%BA%E5%8C%BA/p'   #建邺区
for i in page:
...
dataframe.to_csv("JianYe.csv",index=False, sep=',')
