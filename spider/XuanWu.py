...
'Referer':'http://www.dianping.com/search/keyword/5/10_%E7%8E%84%E6%AD%A6%E5%8C%BA',
...
url='http://www.dianping.com/search/keyword/5/10_%E7%8E%84%E6%AD%A6%E5%8C%BA/p'   #玄武区
for i in page:
...
dataframe.to_csv("XuanWu.csv",index=False, sep=',')
