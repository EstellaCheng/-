...
page=list(range(1,47,1))
url='http://www.dianping.com/search/keyword/5/10_%E9%AB%98%E6%B7%B3%E5%8C%BA/p' #高淳区
for i in page:
...
dataframe.to_csv("gaochun.csv",index=False, sep=',')
