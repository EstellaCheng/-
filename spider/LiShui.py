...
page=list(range(1,43,1))
url='http://www.dianping.com/search/keyword/5/10_%E6%BA%A7%E6%B0%B4%E5%8C%BA/m6' #溧水区
for i in page:
...
dataframe.to_csv("LiShui.csv",index=False, sep=',')
