...
url='http://www.dianping.com/search/keyword/5/10_%E5%85%AD%E5%90%88%E5%8C%BA/p'  #六合区
for i in page:
...
dataframe.to_csv("LiuHe.csv",index=False, sep=',')
